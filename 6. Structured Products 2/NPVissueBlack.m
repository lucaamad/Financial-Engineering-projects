function [NPVa,NPVb]=NPVissueBlack(dates,discounts,spol,coupon,fin_coupon,strike,S0,div,sigma,payment_dates,X)
...
payment_dt=yearfrac(dates(1),payment_dates,Act365);
